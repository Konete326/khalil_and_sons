...
>
    <div class="mx-auto flex max-w-7xl items-center justify-between text-center text-[10px] font-medium tracking-[0.2em] uppercase sm:px-6 lg:px-8">
        <div class="hidden md:flex items-center space-x-2 text-gold-light/80">
