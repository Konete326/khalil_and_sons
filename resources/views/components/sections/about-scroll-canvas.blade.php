<section id="about-scroll-container" data-scroll-container data-sequence-path="{{ asset('assets/about/frame_') }}" data-total-frames="41" data-pad-length="6" data-extension="jpg" data-store-key="aboutScroll" class="relative h-[350vh] sm:h-[400vh] bg-oxblood-dark">
