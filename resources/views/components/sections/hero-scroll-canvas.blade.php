<section id="hero-scroll-container" x-data data-scroll-container data-sequence-path="{{ asset('assets/sequences/hero') }}" data-total-frames="185" data-store-key="heroScroll" class="relative h-[350vh] sm:h-[450vh] bg-oxblood-dark">
