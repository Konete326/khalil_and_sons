<x-layouts.admin :title="'Operations Dashboard | Khalil & Sons Jewellers'">
    <div class="space-y-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 font-mono">
            <div class="border border-gold-antique/30 bg-oxblood-dark/90 p-5 shadow-xl">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
            <div class="lg:col-span-2 border border-gold-antique/30 bg-oxblood-dark/80 p-6 shadow-2xl">
                            ...
                            @forelse($recentOrders as $ord)
                                <tr class="hover:bg-black/30 transition">
                                    ...
                                    <td class="py-3 text-right">
                                        <a href="{{ route('admin.orders.show', $ord) }}" class="border border-gold-antique/40 px-2.5 py-1 text-[10px] text-gold-light hover:bg-gold-antique hover:text-oxblood-dark transition">Inspect</a>
                                    </td>
                                </tr>
                            @empty
                                <tr>
            ...
            <div class="space-y-6">
                <div class="border border-gold-antique/30 bg-oxblood-dark/80 p-6 shadow-2xl">
                    ...
                    <div class="space-y-3">
                        <a href="{{ route('admin.rates.index') }}" class="block w-full border border-gold-antique/60 bg-gold-antique/10 hover:bg-gold-antique hover:text-oxblood-dark p-3 text-xs uppercase tracking-widest text-gold-light transition text-center font-semibold">1-Click Sarafa Override</a>
                        <a href="{{ route('admin.orders.index', ['status' => 'pending_slip']) }}" class="block w-full border border-amber-500/60 bg-amber-500/10 hover:bg-amber-500 hover:text-black p-3 text-xs uppercase tracking-widest text-amber-300 transition text-center font-semibold">Verify Customer Slips ({{ $pendingSlipsCount }})</a>
                        <a href="{{ route('admin.payments.index') }}" class="block w-full border border-gold-antique/40 hover:bg-white/10 p-3 text-xs uppercase tracking-widest text-ivory-base transition text-center">Manage Bank Accounts</a>
                    </div>
                </div>

                <div class="border border-gold-antique/30 bg-black/50 p-5 text-xs font-mono space-y-2 text-ivory-base/80">
